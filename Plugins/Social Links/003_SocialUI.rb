...
class Window_Social_Menu < Window_DrawableCommand
    ...
    def drawItem(index, _count, rect)
        ...
        img_x = 275
        img_x -= 25 if SocialLinkSettings::ALT_COLOR_BOND_ICON_AT_MAX && bond >= bond_level_max
...
class SocialMedia_Scene
    ...
    def pbStartScene
        ...
        #Bond Scale
        imgpos = []
		bondrank = @profile.bond / 10
		bondprogress = @profile.bond % 10
		i = 0
		while i < bondrank
